                ...
                <div class="homepage owl-carousel">
                    ...
                    <div class="item">
                        <div class="row">
                            ...
                            <div class="col-md-7"><img src="img/diseno-grafico-valencia-branding.png" alt="" class="img-fluid"></div>
                        </div>
                    </div>
                    ...
                    <div class="item">
                        <div class="row">
                            <div class="col-md-7"><img src="img/devices.png" alt="" class="img-fluid"></div>
                            <div class="col-md-5">
                                <h1>FACIL DE COMPRAR</h1>
                                <ul class="list-unstyled">
                                    <li>Elegí tus prendas y calculá tu talle</li>
